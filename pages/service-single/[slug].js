    ...
    <Fragment>
      ...
      <section className="service-single-page">
        <div className="container-fluid">
          <div
            className="service-image scroll-text-animation"
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-4  col-12">
              <div
                className="video"
                style={{ backgroundImage: `url(${"/images/wpo-video.jpg"})` }}
              >
          ...
          <div className="dream-wrap">
            <div className="title">
              ...
              <p>
                ...
                and scrambled.Lorem ipsum dolor sit amet consectetur. Sit
                aliquam dignissim situt id amet cyrium. Nulla thurg varius purus
                bibendum pellentesque eu sit nascetur vitae. Nibh tortor
                etrutnibh tincidunt tempor proin. Est placerat felis
                pellentesque temupus condimentum consectetur. Faucibus nunc
                pellentesque ac mus posuere aliquam mor augue orci. Egestas
                donec sit pellentesque lacus.
              </p>
            </div>
      ...
      <section className="service-business section-padding">
        <div className="container-fluid">
            ...
            <div className="row align-items-center">
              <div className="col-lg-6 col-12">
                <h2
                  ...
                  data-animation="fade_from_bottom"
                >
                  Your Dream Our Endless Passion
                </h2>
              </div>
              <div className="col-lg-6 col-12">
                <p
          ...
          <div className="image-wrap">
            <div className="row">
              <div
                className="col col-lg-6 col-md-12 col-12 scroll-text-animation"
                data-animation="fade_from_bottom"
              >
                <div className="image">
