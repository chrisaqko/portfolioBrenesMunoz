            ...
            >
              <div className="widget about-widget">
                ...
                <p>
                  ...
                  SketchUp, Adobe Suite · Architectural drawings & 3D modeling
                </p>
                <div className="social-widget">
                  <ul>
                    <Link
                      onClick={ClickHandler}
                      href="https://www.linkedin.com/in/jonnathan-brenes-mu%C3%B1oz-12729824a/"
                    >
          ...
          <div className="row g-0">
            <div className="col col-lg-6 col-12">
              <p className="copyright">
                {" "}
                Copyright &copy; 2026 Architect Jonnathan Brenes. All Rights
                Reserved.
              </p>
            </div>
            <div className="col col-lg-6 col-12">
